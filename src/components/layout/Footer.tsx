  ...
  return (
    <footer className="border-t border-black/[0.16] dark:border-white/[0.06] bg-[#f5f6fa] dark:bg-[#07070e]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
              ...
              {LINKS_CONTRACT.map((l) => (
                <li key={l.label}>
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-[#8b8ba8] hover:text-slate-900 dark:hover:text-white transition-colors duration-200"
                  >
                    {l.label}
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-6 border-t border-black/[0.14] dark:border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-400 dark:text-[#4a4a6a]">
        ...
        {/* Disclaimer */}
        <p className="mt-4 text-[11px] text-slate-400 dark:text-[#3f3f52] leading-relaxed max-w-2xl">
